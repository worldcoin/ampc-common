...
use ampc_secret_sharing::shares::{Ring48, VecShareReplicated};
...
/// For each group of distances, reduces them to the minimum distance using pairwise minimums.
pub async fn reduce_to_min_distance_batch(
    session: &mut Session,
...
mod tests {
    ...
    use crate::{
        ...
        protocol::{
            fhd_ops::translate_threshold_a, ops::open_ring,
