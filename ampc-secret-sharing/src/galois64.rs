pub mod degree4 {
    ...
    /// An element of the Galois ring `$\mathbb{Z}_{2^{64}}[x]/(x^4 - x - 1)$`.
    ...
    impl GaloisRingElement<Monomial> {
        ...
        pub fn encode1(x: &[u64]) -> Option<Vec<Self>> {
        ...
        pub fn encode2(x: &[u64]) -> Option<Vec<Self>> {
            #[allow(clippy::manual_is_multiple_of)]
            if x.len() % 4 != 0 {
                return None;
            }
        ...
        pub fn inverse(&self) -> Self {
            ...
            const R: u32 = 4;
            const M: u32 = 64;
            const EXP: u128 = (P.pow(R) - 1) * P.pow(M - 1) - 1;
        ...
        pub fn to_basis_A(self) -> GaloisRingElement<basis::A> {
            ...
            // [                   1                    0                    0                    0]
            // [14725063672648506654                    1                    0                    0]
            // [ 8777195992721623281 15339178893946101142                    1                    0]
            // [13530180109259149624  7779522894491480362   962685220847427917                    1]
            GaloisRingElement {
                coefs: [
                    self.coefs[0],
                    self.coefs[1].wrapping_add(self.coefs[0].wrapping_mul(14725063672648506654)),
                    self.coefs[2]
                        .wrapping_add(self.coefs[0].wrapping_mul(8777195992721623281))
                        .wrapping_add(self.coefs[1].wrapping_mul(15339178893946101142)),
                    self.coefs[3]
                        .wrapping_add(self.coefs[0].wrapping_mul(13530180109259149624))
                        .wrapping_add(self.coefs[1].wrapping_mul(7779522894491480362))
                        .wrapping_add(self.coefs[2].wrapping_mul(962685220847427917)),
                ],
                basis: PhantomData,
            }
        }
        ...
        pub fn to_basis_B(self) -> GaloisRingElement<basis::B> {
            ...
            // [11733401638094454438 14492865330106577540  4916563964450401993 13530180109259149624]
            // [14492865330106577540  4916563964450401993 13530180109259149624  7779522894491480362]
            // [ 4916563964450401993 13530180109259149624  7779522894491480362   962685220847427917]
            // [13530180109259149624  7779522894491480362   962685220847427917                    1]
            GaloisRingElement {
                coefs: [
                    (self.coefs[0].wrapping_mul(11733401638094454438))
                        .wrapping_add(self.coefs[1].wrapping_mul(14492865330106577540))
                        .wrapping_add(self.coefs[2].wrapping_mul(4916563964450401993))
                        .wrapping_add(self.coefs[3].wrapping_mul(13530180109259149624)),
                    (self.coefs[0].wrapping_mul(14492865330106577540))
                        .wrapping_add(self.coefs[1].wrapping_mul(4916563964450401993))
                        .wrapping_add(self.coefs[2].wrapping_mul(13530180109259149624))
                        .wrapping_add(self.coefs[3].wrapping_mul(7779522894491480362)),
                    (self.coefs[0].wrapping_mul(4916563964450401993))
                        .wrapping_add(self.coefs[1].wrapping_mul(13530180109259149624))
                        .wrapping_add(self.coefs[2].wrapping_mul(7779522894491480362))
                        .wrapping_add(self.coefs[3].wrapping_mul(962685220847427917)),
                    (self.coefs[0].wrapping_mul(13530180109259149624))
                        .wrapping_add(self.coefs[1].wrapping_mul(7779522894491480362))
                        .wrapping_add(self.coefs[2].wrapping_mul(962685220847427917))
    ...
    impl GaloisRingElement<basis::A> {
        pub fn to_monomial(self) -> GaloisRingElement<Monomial> {
            ...
            GaloisRingElement {
                coefs: [
                    self.coefs[0],
                    self.coefs[1].wrapping_add(self.coefs[0].wrapping_mul(3721680401061044962)),
                    self.coefs[2]
                        .wrapping_add(self.coefs[0].wrapping_mul(8289148916157705379))
                        .wrapping_add(self.coefs[1].wrapping_mul(3107565179763450474)),
                    self.coefs[3]
                        .wrapping_add(self.coefs[0].wrapping_mul(11432970333055501229))
                        .wrapping_add(self.coefs[1].wrapping_mul(7744929693175761652))
                        .wrapping_add(self.coefs[2].wrapping_mul(17484058852862123699)),
                ],
                basis: PhantomData,
            }
        }
    ...
    impl<B: Basis> GaloisRingElement<B> {
        pub const fn from_coefs(coefs: [u64; 4]) -> Self {
            GaloisRingElement {
                coefs,
                basis: PhantomData,
            }
    ...
    impl std::ops::Add for ShamirGaloisRingShare {
        type Output = Self;
        fn add(self, rhs: Self) -> Self::Output {
            assert_eq!(self.id, rhs.id, "ids must be equal");
    ...
    mod tests {
        ...
        use crate::galois64::degree4::basis;
        ...
        fn dot(a: &[u64; 4], b: &[u64; 4]) -> u64 {
            a.iter()
                .zip(b.iter())
                .fold(0u64, |x, (a, b)| x.wrapping_add(a.wrapping_mul(*b)))
        }
